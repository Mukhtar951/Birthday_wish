...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date('Oct 6, 2025 00:00:00').getTime(),
...
new TypeIt("#teks1", {
  strings: ["Hey, just wanted to wish you a truly happy birthday. I hope this year brings you peace, growth, and all the beautiful things you deserve. Enjoy your day to the fullest.", " ", "Wish you more joyous years ahead+AbulBash...+Abundant and rightful knowledge.", " ", "Wish you all the best", " ", "Mukhtar Aminu..."],
  startDelay: 4000,
  speed: 75,
